...
public class FightingSkillWeaponHoldLeftArm extends FightingSkillBaseWeaponSkills {

	FightingSkillWeaponHoldLeftArm(DynamicGameObject master) {
		super(Statics.FightingSkills.WEAPON_HOLD_LEFT_ARM, master);
	}
