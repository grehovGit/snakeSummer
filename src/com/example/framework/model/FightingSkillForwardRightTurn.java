...
public class FightingSkillForwardRightTurn extends FightingSkillBaseCicks {

	FightingSkillForwardRightTurn(DynamicGameObject master) {
		super(Statics.FightingSkills.FORWARD_RIGHT_TURN, master);
	}
