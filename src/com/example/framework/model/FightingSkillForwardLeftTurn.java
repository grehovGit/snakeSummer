...
public class FightingSkillForwardLeftTurn extends FightingSkillBaseCicks {

	FightingSkillForwardLeftTurn(DynamicGameObject master) {
		super(Statics.FightingSkills.FORWARD_LEFT_TURN, master);
	}
