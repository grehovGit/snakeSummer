...
public class FightingSkillImpulseDeffenseRightSide extends FightingSkillBaseMagicSkills {

	FightingSkillImpulseDeffenseRightSide(DynamicGameObject master) {
		super(Statics.FightingSkills.IMPULSE_DEFFENSE_RIGHTSIDE, master);
	}
				...
				if(dTime >= 0 && dTime <= master.stateHS.strikePeriod) {
					if (!sPart.stateHS.striked) {
						...
						master.world.world2d.fSkillSideImpulse(Statics.FightingSkills.FIGHTSKILL_IMPULSE_POWER_STEP * attackPower,
							 	master.stateHS.attackPower /*TEMPORARY*/, workDistance, sPart, false);
